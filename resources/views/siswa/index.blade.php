...
@section('content')
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary to-blue-700 p-6 sm:p-8 shadow-lg">
            ...
            <div class="relative">
                <div class="mb-4 inline-flex items-center gap-2 rounded-full bg-white/20 px-3 py-1 backdrop-blur-sm">
                    ...
                    <span class="text-xs font-medium text-white">Status: Aktif Magang</span>
                </div>

                <h1 class="text-white text-2xl sm:text-3xl font-bold tracking-tight">Halo, Dimas Adrian</h1>
                <p class="text-blue-100 text-sm sm:text-base mt-1 opacity-90">TKJ 2 • Angkatan 2024/2025</p>
                ...
                <div class="mt-6 flex items-center gap-3 text-white">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-semibold">Bios Komputer - Pekanbaru</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="px-4 sm:px-6 pb-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="{{ url('/siswa/riwayat') }}" class="group flex flex-col items-start gap-3 rounded-2xl bg-white dark:bg-gray-700/50 p-4 transition-all hover:ring-2 hover:ring-slate-200 border border-slate-100 dark:border-gray-700 shadow-sm">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-slate-50 dark:bg-gray-800 text-slate-500 group-hover:bg-slate-600 group-hover:text-white transition-all">
                    <span class="material-symbols-outlined text-2xl">history</span>
                </div>
                <div class="text-left">
                    <h2 class="text-sm font-bold">Riwayat</h2>
                    <p class="text-slate-500 dark:text-slate-400 text-[11px] mt-1 leading-tight">Lihat semua catatan lampau</p>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="px-4 sm:px-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <button class="text-primary text-xs font-semibold hover:bg-primary/5 px-3 py-1 rounded-lg transition-colors">Lihat Semua</button>
        </div>
        ...
        <div class="space-y-3">
            <div class="flex items-center gap-4 rounded-xl bg-white dark:bg-gray-800 p-4 shadow-sm border border-slate-100 dark:border-gray-700 transition-all hover:border-primary/30">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold truncate text-slate-900 dark:text-white">Absensi Masuk Berhasil</p>
                    <p class="text-slate-500 dark:text-slate-400 text-xs truncate">Hari ini, 07:45 WIB • Bios Komputer</p>
                </div>
